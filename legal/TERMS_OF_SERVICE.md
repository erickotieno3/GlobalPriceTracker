...
- Modifying, creating derivative works, copying, distributing, transmitting, displaying, performing, reproducing, publishing, licensing, creating derivative works from, transferring, or selling any information or content obtained from the Service
- Reverse engineering, decompiling, or disassembling any portion of the Service
- Removing any copyright, trademark or other proprietary notices from any portion of the Service
- Creating a product, service, or software that is, in any way, substantively similar to the Service
- Attempting to gain unauthorized access to the Service
- Copying or adapting the HTML, JavaScript, CSS, or other code used to generate pages of the Service
...
- To violate any applicable local, state, national, or international law, rule, or regulation
- To infringe or violate the intellectual property rights or any other rights of others
- To transmit material that is defamatory, offensive, or otherwise objectionable
- To send unauthorized advertising or spam
- To impersonate any person or entity
- To interfere with or disrupt the Service or servers or networks connected to the Service
- To attempt to gain unauthorized access to parts of the Service, other accounts, computer systems, or networks connected to the Service
- To harvest or collect email addresses or other contact information by automated means
- To engage in any conduct that restricts or inhibits anyone's use or enjoyment of the Service

## 5. Content and Data Rights
...
## 7. Third-Party Websites, Services, and Affiliate Links
...
Our Service contains affiliate marketing links, which means we may receive a commission if you click on a link and purchase a product that we have recommended. This does not affect your price or consumer rights.
...
Any unauthorized access to the Service or unauthorized use of intellectual property may subject the offender to civil liability and criminal prosecution under applicable laws in the United Kingdom, European Union, United States, Kenya, or any other relevant jurisdiction.
